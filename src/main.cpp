...
int main()
{
   ...
   GrassShader grassShader("../resources/shaders/grassShader.vert", "../resources/shaders/grassShader.frag", "../resources/shaders/grassShader.geom");
...
std::vector<float> generate_biome(const std::vector<float> &vertices, std::vector<plant> &plants, int xOffset, int yOffset)
{
    ...
    { // x, y, z, so look at every y value
        int k = 0;
